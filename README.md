...
## 📄 PDF Content (Submission Guide)
Use this structure for your final submission PDF:

**Page 1: Executive Summary**
- **Headline**: High-Throughput Incident Management System (10k signals/sec)
- **Objective**: Build a resilient, async system with SRE-level durability and automated debouncing.
- **Author**: Satya
- **GitHub**: [Link]

**Page 2: Architecture & Tech Stack**
- Architecture Diagram (Mermaid logic)
- Justification: Why Redis Streams? Why MongoDB + Postgres split?

**Page 3: Core Logic**
- **Debouncing Strategy**: Redis atomic SET NX EX logic.
- **State Pattern**: Validating incident transitions.
- **Strategy Pattern**: Component-to-severity mapping.

**Page 4: Resilience & Reliability**
- **Backpressure**: Decoupling producers/consumers.
- **Concurrency**: PostgreSQL versioning/optimistic locking.
- **Failure Handling**: Exponential backoff and durable queueing.

**Page 5: Implementation & Verification**
